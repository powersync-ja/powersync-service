...
import { emptyChecksumForRequest, FetchPartialBucketChecksumV3 } from '../MongoChecksums.js';
...
export async function fetchPreStates(
  normalizedBatch: FetchPartialBucketChecksumV3[],
