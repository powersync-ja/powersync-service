...
const rawParityCases: ConverterCase[] = [
  serializableCase('double', new Double(1.25)),
  serializableCase('string', 'line 1\nline "2" \\ snowman ☃ \u0001'),
  serializableCase('document', { alpha: 1, bravo: 'two', charlie: true, delta: null }),
  serializableCase('array', [1, 'two', false, null, { deep: 3 }]),
  serializableCase('objectId', objectId),
  serializableCase('bool', true),
