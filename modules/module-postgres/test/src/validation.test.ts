...
import { UpdateSyncRulesOptions } from '@powersync/service-core';
...
`;
  ...
  const syncRules = await context.factory.updateSyncRules(UpdateSyncRulesOptions.fromYaml(syncRuleContent));
